    ...
    ZStack {
      ...
      VStack(alignment: .center, spacing: 5) {
        ...
        HStack {
          ...
          Spacer()
          //here were betting with only 10
          HStack(alignment: .center, spacing: 10) {
            Image("gfx-casino-chips")
              .resizable()
        ...
        ZStack {
          ...
          VStack(spacing: 0) {
            ...
            VStack(alignment: .center, spacing: 16) {
              ...
              Text("I have bad news for you, you have Bad luck! You lost all of your coins. \nLet's play again!")
              ...
              Button(action: {
                ...
                Text("Let's Play A New Game".uppercased())
                  .font(.system(.body, design: .rounded))
                  .fontWeight(.semibold)
